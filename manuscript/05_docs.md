...
![Docs on Google Drive](images/05_docs/05_google_docs-1.png)
...
![Google Docs Page](images/05_docs/05_google_docs-2.png)
...
![Google Docs Templates Gallery](images/05_docs/05_google_docs-3.png)
...
![A-Z List](images/05_docs/05_google_docs-4.png)
...
![Offline mode on](images/05_docs/05_google_docs-5.png)

Toggle the "Offline" switch to on. 

![Offline mode on](images/05_docs/05_google_docs-6.png)
...
![Opening a blank Doc](images/05_docs/05_google_docs-7.png)
...
![Blank Google Doc](images/05_docs/05_google_docs-8.png)
...
![Formatting from the toolbar in Google Docs](images/05_docs/05_google_docs-9.png)
...
![Formatted title within Google Docs](images/05_docs/05_google_docs-10.png)
...
![options to create a numbered or bulleted list](images/05_docs/05_google_docs-12.png)
...
![Insert an image icon](images/05_docs/05_google_docs-13.png)
...
![R language image search](images/05_docs/05_google_docs-14.png)
...
![Google Image search](images/05_docs/05_google_docs-15.png)
...
!["Copy Image Address" menu](images/05_docs/05_google_docs-16.png)
...
![Insert Image icon and select "By URL"](images/05_docs/05_google_docs-17.png)

In the box that pops up, you'll then paste the URL that you just copied by using the keyboard shortcut `ctrl + v`. 

![Insert image by pasting URL](images/05_docs/05_google_docs-18.png)

The image you selected will automatically appear in that box. Now, you just have to click "INSERT."

![Click INSERT to insert image](images/05_docs/05_google_docs-19.png)

The image will now appear in your Google Doc!

![image inserted in Google Doc from URL](images/05_docs/05_google_docs-20.png)
...
![image inserted in Google Doc from URL with source](images/05_docs/05_google_docs-21.png)
...
![Select "Upload from computer"](images/05_docs/05_google_docs-22.png)
...
![Select image from Downloads in Documents that appear](images/05_docs/05_google_docs-23.png)
...
![Image inserted from computer](images/05_docs/05_google_docs-24.png)
...
![Insert table](images/05_docs/05_google_docs-25.png)
...
![Insert table using highlighted cells](images/05_docs/05_google_docs-26.png)

In this case, a 4x2 (meaning 4 columns and 2 rows) has been inserted in your document.

![table inserted within a Google Doc](images/05_docs/05_google_docs-27.png)
...
![Additional table options can be accessed by double clicking within a table](images/05_docs/05_google_docs-28.png)
...
![renamed Google Doc](images/05_docs/05_google_docs-29.png)
...
![Downloading documents](images/05_docs/05_google_docs-30.png)
